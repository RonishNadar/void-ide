...
contextBridge.exposeInMainWorld('voidIDE', {
  ...
  libExamples:   ()     => ipcRenderer.invoke('cli:lib-examples'),
  configDump:    ()     => ipcRenderer.invoke('cli:config-dump'),
  compileCheck:  (args) => ipcRenderer.invoke('cli:compile-check', args),
  listDir:       (args) => ipcRenderer.invoke('fs:list-dir', args),
  deleteFile:    (args) => ipcRenderer.invoke('fs:delete-file', args),
  readFile:      (args) => ipcRenderer.invoke('cli:read-file', args),
